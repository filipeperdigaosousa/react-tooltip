...
class ReactTooltip extends Component {
  ...
  addScrollListener (e) {
    ...
    this.getScrollHideListenerNode().forEach((n) => { n.addEventListener('scroll', this.hideTooltip, isCaptureMode) })
  }

  removeScrollListener () {
    this.getScrollHideListenerNode().forEach((n) => { n.removeEventListener('scroll', this.hideTooltip) })
  }
  ...
  getScrollHideListenerNode () {
    if (!this.props.scrollHideSelector) {
      ...
      const nodes = document.querySelectorAll(this.props.scrollHideSelector)
      return nodes || window
    }
  }
